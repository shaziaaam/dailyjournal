    ...
    <body>
        ...
        <div class="container">
            <a class="navbar-brand" href="#">Jia's Daily Journal</a>
            <button
        ...
        <div class="container">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://d1bvpoagx8hqbg.cloudfront.net/originals/big-ben-queen-elisabeth-tower-7fcceb2ceeddc3ef5bb7aaf489f4b4b1.jpg" class="d-block w-100" alt="bigben" width="50px" height="800px">
                </div>
                <div class="carousel-item">
                    <img src="https://images5.alphacoders.com/458/thumb-1920-458520.jpg" class="d-block w-100" alt="londoneye" width="50px" height="800px">
                </div>
                <div class="carousel-item">
                    <img src="https://wallpaperaccess.com/full/3700116.jpg" class="d-block w-100" alt="bakerstreet" width="50px" height="800px">
                </div>
                <div class="carousel-item">
                    <img src="https://images6.alphacoders.com/771/thumb-1920-771019.jpg" class="d-block w-100" alt="abbey" width="50px" height="100%">
                </div>
                <div class="carousel-item">
                    <img src="https://wallpapercave.com/wp/wp2150406.jpg" class="d-block w-100" alt="palace" width="50px" height="800px">
                </div>
            <button
